...
public class Illa implements Serializable{
    ...
    public Illa(String illa, String nomIlla) throws JPAException {
        setIlla(illa);
        setNomIlla(nomIlla);
    }
    ...
    public void setIlla(String illa) throws JPAException {
        if (!illa.trim().isEmpty()) {
            if (illa != null) {
                this.illa = illa;
            } else {
                throw new JPAException ("Illa no pot ser null");
            }
        } else {
            throw new JPAException("Illa no pot estar buid");
        }
    }
    ...
    public void setNomIlla(String nomIlla) throws JPAException {
        if (!nomIlla.trim().isEmpty()) {
            if (nomIlla != null) {
                this.nomIlla = nomIlla;
            } else {
                throw new JPAException ("nomIlla no pot ser null");
            }
        } else {
            throw new JPAException("nomIlla no pot estar buid");
        }
