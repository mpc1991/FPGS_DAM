...
public class Aspirant {
    ...
    public Aspirant(String nif, String nom, String llinatges, String adreca, String codiPostal, Localitat localitat) throws JPAException {
        this.nif = nif;
        setNom(nom);
    ...
    public Aspirant() throws JPAException {
    }
    ...
    public void setNom(String nom) throws JPAException {
        if(nom==null || nom.isBlank()){
            throw new JPAException("El nom no potser null ni buid.");
        }
        this.nom = nom;
    }
    ...
    public void setLlinatges(String llinatges) throws JPAException {
        if(llinatges==null || llinatges.isBlank()){
            throw new JPAException("Els llinatges no poden ser null ni buids.");
        }
