...
*/
class DBProvider{
  static Database? _database; // Objeto tipo Database de sqflite

  static final DBProvider db = DBProvider._();

  DBProvider._(){} //constructor vacío privado

  // Inicializamos la tabla si no existe
