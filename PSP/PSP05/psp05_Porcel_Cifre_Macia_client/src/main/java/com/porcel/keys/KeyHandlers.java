...
public class KeyHandlers {
    ...
    // Cifra la clave AES usando la clave pública del servidor con algoritmo RSA
    ...
    public static String descifrarMensajeAES(String mensajeCifradoBase64, SecretKey secretKey) throws Exception {
        ...
        // Crear un Objeto de Cipher para descifrar con AES
        Cipher cipher = Cipher.getInstance("AES");
        cipher.init(Cipher.DECRYPT_MODE, secretKey); // Iniciar el des-cifrado con la clave secreta

        // Des-cifrar los datos y devolverlos
